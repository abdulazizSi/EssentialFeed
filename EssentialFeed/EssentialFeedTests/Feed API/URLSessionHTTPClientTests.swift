...
class URLSessionHTTPClientTests: XCTestCase {
    ...
    func test_getFromURL_succeedsOnHTTPURLResponseWithData() {
        let anyData = anyData()
        let anyURLResponse = anyHTTPURLResponse()
        ...
        makeSUT().get(from: anyURL()) { result in
            ...
            case let .success((receivedData, receivedResponse)):
                ...
                XCTAssertEqual(receivedResponse.url, anyURLResponse.url)
                XCTAssertEqual(receivedResponse.statusCode, anyURLResponse.statusCode)
            default:
    ...
    func test_getFromURL_succeedsWithEmptyOnHTTPURLResponseWithNilData() {
        let anyURLResponse = anyHTTPURLResponse()
        URLProtocolStub.stub(data: nil, response: anyURLResponse, error: nil)
